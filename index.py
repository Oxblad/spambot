...
def send_for_number(phone):
    ...
    try:
        ...
        print('[-] Не отправлено!')
    try:
        requests.post('https://requests.service.banki.ru/form/960/submit',
                      params={"callback": "submitCallback", "name": self.russian_name,
                              "phone": "+" + self.formatted_phone, "email": self.email, "gorod": "Москва",
                              "approving_data": "1", })
